...
export default function Select(props) {
  ...
  return (
    <div className='w-44 my-0 mx-auto shadow-md shadow-red-500 hover:shadow-lg hover:shadow-red-500'>
        <select id="select" defaultValue="Choose a planet" onChange={props.func} className="block py-2.5 px-0 mt-3 mb-3 w-full text-sm bg-transparent text-center appearance-none focus:outline-none">
            <option value="Earth">Planets</option>
            <option value="Earth">Dwarf Planets</option>
            <option value="Earth">Moons</option>
            <option value="Earth">Asteroids</option>
            <option value="Earth">Comets</option>
         </select>
    </div>
  )
}
